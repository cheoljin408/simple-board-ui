<template>
  <footer class="bg-gray-600 mt-28 w-full h-40 shadow flex">
    <div class="justify-center w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center md:justify-between">
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-200">
        © 2023 Simple Board. All Rights Reserved.
      </span>
